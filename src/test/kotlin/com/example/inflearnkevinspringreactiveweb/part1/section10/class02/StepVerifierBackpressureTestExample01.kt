...
import com.example.inflearnkevinspringreactiveweb.part1.section10.class02.BackpressureExample.generateNumberByErrorStrategy
 ...
 */
class StepVerifierBackpressureTestExample01 {
    @Test
    fun generateNumberTest() {
        StepVerifier
            .create(generateNumberByErrorStrategy(), 1L)
