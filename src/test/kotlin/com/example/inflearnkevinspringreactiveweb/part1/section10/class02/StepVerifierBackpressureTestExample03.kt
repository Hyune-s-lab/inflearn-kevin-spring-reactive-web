...
import com.example.inflearnkevinspringreactiveweb.part1.section10.class02.BackpressureExample.generateNumberByDropStrategy
 ...
 */
class StepVerifierBackpressureTestExample03 {
    @Test
    fun generateNumberTest() {
        StepVerifier
            .create(generateNumberByDropStrategy(), 1L)
